                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex flex-wrap gap-2">
                          {entry.status === 'waiting' && (
                            <button
                              onClick={() => handleConfirmPlayer(entry.user.id)}
                              disabled={actionLoading === `confirm-${entry.user.id}`}
                            ...
                            >
                              {actionLoading === `confirm-${entry.user.id}` ? 'Confirming...' : 'Confirm'}
                            </button>
                          )}
                          {entry.user.phone && entry.status === 'waiting' && (
                            <button
                              onClick={() => handleSendSMSConfirmation(entry.user.id)}
                              disabled={actionLoading === `sms-${entry.user.id}`}
                            ...
                            >
                              {actionLoading === `sms-${entry.user.id}` ? 'Sending...' : 'Send SMS'}
                            </button>
                          )}
                          <button
                            onClick={() => handleRemovePlayer(entry.user.id)}
                            disabled={actionLoading === `remove-${entry.user.id}`}
                          ...
                          >
                            {actionLoading === `remove-${entry.user.id}` ? 'Removing...' : 'Remove'}
                          </button>
                        </div>
                      </td>
                    </tr>
